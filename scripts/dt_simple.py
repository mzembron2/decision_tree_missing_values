...
class Node():
    def __init__(self, feature_index = None, threshold=None, left = None, right=None, info_gain=None, value=None, deafult_value_for_missing_values = None):
        #for decision node
...
class DecisionTreeClassifier():
    ...
    def make_prediction(self, x, tree):
        ...
        ## IF feature_value IS NOT MISSING:
